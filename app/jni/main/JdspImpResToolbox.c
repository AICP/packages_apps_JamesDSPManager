...
SF_INFO sfiIRInfo;
SNDFILE *sfIRFile;
JNIEXPORT jintArray JNICALL Java_james_dsp_activity_JdspImpResToolbox_GetLoadImpulseResponseInfo(JNIEnv *env,
                                                                                                       jobject obj,
                                                                                                       jstring path) {
...
JNIEXPORT jfloatArray JNICALL Java_james_dsp_activity_JdspImpResToolbox_ReadImpulseResponseToFloat(JNIEnv *env,
                                                                                                         jobject obj,
...
JNIEXPORT jstring JNICALL Java_james_dsp_activity_JdspImpResToolbox_OfflineAudioResample(JNIEnv *env,
                                                                                               jobject obj,
                                                                                               jstring path,
                                                                                               jstring filename,
                                                                                               jint targetSampleRate) {
...
JNIEXPORT jint JNICALL Java_james_dsp_activity_JdspImpResToolbox_FFTConvolutionBenchmark(JNIEnv *env,
                                                                                               jobject obj,
                                                                                               jint entriesGen,
                                                                                               jint fs,
                                                                                               jdoubleArray c0,
